...
#define IS_MOVE_PHYSICAL(move)(GetBattleMoveCategory(move) == MOVE_CATEGORY_PHYSICAL)
#define IS_MOVE_SPECIAL(move)(GetBattleMoveCategory(move) == MOVE_CATEGORY_SPECIAL)
